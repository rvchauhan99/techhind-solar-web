/**
 * Quotation form configuration — sections, initial state, and constants.
...
export const TECHNICAL_SECTIONS = [
    ...
    { key: "accessories", typeNames: ["accessories"], title: "Accessories" },
...
export function getInitialFormData(user, overrides = {}) {
    ...
    return {
        ...
        // Multi-item cable/product-type support (esp. from Project BOM duplicates)
        cable_ac_items: [],
        cable_dc_items: [],
        cable_la_items: [],
        ...
        payment_terms: "",
        remarks: "",
        graph_price_per_unit: 8.5,
        graph_per_day_generation: 4,
        graph_yearly_increment_price: 2.5,
        graph_yearly_decrement_generation: 0.5,
        project_cost: "",
        total_payable: "",
        effective_cost: "",
        ...overrides,
