...
/**
 * Clear all project-driven technical + price fields when Select Project changes.
 * Does not touch customer/basic/graph defaults.
 */
export function getProjectDrivenResetPatch() {
    return {
        project_capacity: "",
        price_per_kw: "",
        total_project_value: "",
